...
{
    /**
     * Set default properties, in case if all your images follow the same settings.
     * @var array
     */
    ...
    /**
     * Set file size by giving an array value for max, and min sizes
    ...
    /**
     * If this method is called and set, then the class
     * will assume, the file getting uploaded is an image.
    ...
    /**
     * Assign message for each of the possible errors that may be thrown by the $_FILES array.
     * @return array
     */
    ...
    /**
     * A final method to call, which validates and uploads the file and returns the
    ...
    public function upload($fileToUpload, $newFileName = null)
    {
         ...
         * so to compare it with what is specified. ex: array('jpg','png',''gif)
         */
        $fileTypeExtension = substr($fileToUpload['type'], 6);


        /**
         * Since getExtension and FILES[]['type'] give often different
         * names, ex: "jpeg & jpg" ".doc & application/msword"
        ...
        /**
         * IMPORTANT:
         * If user has already set a value for $allowedFileDimensions, it means user is trying to
         * upload an image, that means we can validate the image size, if however $allowedFileDimensions is not
         * set, or set to null, then we'll assume user want to upload other files, so image size is irrelevant here.
         */
